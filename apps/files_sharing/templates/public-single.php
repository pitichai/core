	...
	<div id="preview">
		...
		<?php else: ?>
			<div id="imgframe">
				...
				<img
					src="<?php p(OCP\Util::linkToRoute( 'core_ajax_public_preview', array('x' => $size, 'y' => $size, 'file' => $_['filename'], 't' => $_['sharingToken']))); ?>"
					class="publicpreview"
					alt="" />
			</div>
		<?php endif; ?>
